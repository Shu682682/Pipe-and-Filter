...
//讀取數據寫成csv.file
//output csv. ned data
public class SinkFilter_T extends FilterFrameworkT {
	//Add an ArrayList
	private static List<String> list = new ArrayList<>();
	public static void main(String[] args) {
		SinkFilter_T filter = new SinkFilter_T();
		filter.run();
	}
		...
		while (true) {
			try {
				 ...
				 ****************************************************************************/
					...
					list.add(outputToCSV(TimeStampFormat.format(TimeStamp.getTime()), velocity, altitude, pressure, temperature));
				}
	...
	public static void writeToCSV(List<String> list) throws IOException {
		FileWriter writer = new FileWriter("outputA(Test).csv");
