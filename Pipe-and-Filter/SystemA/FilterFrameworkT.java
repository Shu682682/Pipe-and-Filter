...
public class FilterFrameworkT extends Thread
{
	...
	private FilterFrameworkT InputFilter;
	...
	****************************************************************************/
	void Connect( FilterFrameworkT Filter )
	{
		try
		{
	...
	* Arguments:
	* 	byte datum - This is the byte that will be written on the output port of the filter.
	* Returns: void
	* Exceptions: IOException
	****************************************************************************/
